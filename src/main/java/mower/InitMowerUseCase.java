...
public class InitMowerUseCase {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(inputValues, that.inputValues) && Objects.equals(grass, that.grass) && Objects.equals(mowersByScenario, that.mowersByScenario);
    }

    @Override
    public int hashCode() {
        return Objects.hash(inputValues, grass, mowersByScenario);
    }
}
